...
namespace simplygoodwork\telemetron\widgets;

use simplygoodwork\telemetron\Telemetron;
use simplygoodwork\telemetron\assetbundles\telemetronwidget\TelemetronWidgetAsset;
 ...
 * @since     1.0.0
 */
class TelemetronWidget extends Widget
{
    ...
    {
        return Craft::t('telemetron', 'Telemetron');
    }
    ...
    {
        return Craft::getAlias("@simplygoodwork/telemetron/assetbundles/telemetronwidget/dist/img/Telemetron-icon.svg");
    }
    ...
    public function getSettingsHtml(): ?string
    {
        return Craft::$app->getView()->renderTemplate(
            'telemetron/_components/widgets/Telemetron_settings',
            [
                'widget' => $this
            ]
        );
    ...
    *
     * @return string|false|null The widget’s body HTML, or `false` if the widget
                    should not be visible. (If you don’t want the widget
                    to be selectable in the first place, use {@link isSelectable()}.)
    */
    public function getBodyHtml(): ?string
    {
        Craft::$app->getView()->registerAssetBundle(TelemetronWidgetAsset::class);

        return Craft::$app->getView()->renderTemplate(
            'telemetron/_components/widgets/Telemetron_body',
            [
